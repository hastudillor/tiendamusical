 ...
 *
 */
package com.henryastudillo.tiendamusicaldata.common;
 ...
 * E - Signifca la entidad a utilizar en el CRUD
 * R - Significa el repositorio de JPA para ejecutar el CRUD
 */
public class CommonDAO<E, R extends PagingAndSortingRepository<E, Long>> {
    ...
    /**
     * Metdo que permite consultar una lista de datos paginable de una Entidad.
     ...
     * @param e {@link Object} objeto o entidad a persistit.
